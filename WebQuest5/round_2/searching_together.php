...
<body>
     <nav class="navbar navbar-dark bg-dark">
        <div class="container">
            <button type="button" class="btn btn-info" onclick="window.open('leader_board.php','_blank')">Leaderboard</button>
            <button type="button" class="btn btn-light"><div id="demo"></div></button>
            <button type="button" class="btn btn-info" onclick="window.open('hints.html','_blank')">Hint</button>
    ...
    <div class="container">
        <div class="container b">
            <div class="row">
                <div class="col">
                    <img src="./images/searching_together.JPG" class="img-fluid" alt="Image">
                </div>
            </div>
            <br>
            <div class="row">
